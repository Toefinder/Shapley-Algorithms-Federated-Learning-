...
if __name__ == '__main__':
    ...
    total_data = sum(len(train_dataset[i]) for i in range(1,m+1))
    fraction = [len(train_dataset[i])/total_data for i in range(1,m+1)]
    # print("data fraction is:", fraction) # print check 

    # decay factor for calculating shapley value   
    decay = 0.01 # this is set to be the same as the learning rate 
    ...
    accuracy_file = open('../save/MRfed_{}_{}_{}_{}.txt'.format(args.dataset, args.model,
